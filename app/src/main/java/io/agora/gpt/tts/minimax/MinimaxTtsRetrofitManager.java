...
public class MinimaxTtsRetrofitManager {
    private MinimaxTtsRequest mMiniMaxRequest;

    private static final class InstanceHolder {
        static final MinimaxTtsRetrofitManager M_INSTANCE = new MinimaxTtsRetrofitManager();
    }

    public static MinimaxTtsRetrofitManager getInstance() {
    ...
    public void init() {
        ...
        // 创建一个request
        mMiniMaxRequest = retrofit.create(MinimaxTtsRequest.class);
    }

    public MinimaxTtsRequest getMinimaxRequest() {
