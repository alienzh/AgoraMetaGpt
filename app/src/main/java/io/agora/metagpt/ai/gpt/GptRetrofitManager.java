...
public class GptRetrofitManager {
    private GptRequest mGptRequest;

    private static final class InstanceHolder {
        static final GptRetrofitManager M_INSTANCE = new GptRetrofitManager();
    }

    public static GptRetrofitManager getInstance() {
    ...
    public void init() {
                ...
                .addInterceptor(new Interceptor() {
                    ...
                    public Response intercept(@NonNull Chain chain) throws IOException {
                        ...
                        Request request = original.newBuilder()
                                ...
                                .addHeader("agora-service-key", BuildConfig.AGORA_SERVICE_KEY)
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .client(client)
                // 设置基址
                .baseUrl(BuildConfig.GPT_SERVER_HOST)
        ...
        // 创建一个request
        mGptRequest = retrofit.create(GptRequest.class);
    }
